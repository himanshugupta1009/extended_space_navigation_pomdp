...
if(run_simulation_flag)
    ...
    env = generate_environment_circular_obstacles(MersenneTwister(15))
    env_right_now = deepcopy(env)

    #Create POMDP for env_right_now
    golfcart_2D_action_space_pomdp = POMDP_Planner_2D_action_space(0.99,1.0,-100.0,1.0,-100.0,1.0,1.0,100.0,3.0,env_right_now,1)
    ...
    just_2D_pomdp_all_gif_environments, just_2D_pomdp_all_observed_environments, just_2D_pomdp_all_generated_beliefs,
            ...
            just_2D_pomdp_time_taken_by_cart, just_2D_pomdp_cart_reached_goal_flag = run_one_simulation(env_right_now, MersenneTwister(111))
