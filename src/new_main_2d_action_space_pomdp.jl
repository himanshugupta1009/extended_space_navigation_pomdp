...
function run_one_simulation(env_right_now, user_defined_rng)
    ...
    return all_gif_environments, all_observed_environments, all_generated_beliefs, all_generated_trees,
                all_risky_scenarios, number_risks, time_taken_by_cart
end
...
gif(anim, "just_2D_action_space_pomdp_planner_run.gif", fps = 5)



# global time_taken_by_cart = 0
# global number_risks = 0
# global one_time_step = 0.5
# global lidar_range = 30
# global num_humans_to_care_about_while_pomdp_planning = 10
# global cone_half_angle = pi/3.0
# global cart_ran_into_boundary_wall_near_goal_flag = false
# global filename = "output_just_2d_action_space_pomdp_planner.txt"
# global user_defined_rng = MersenneTwister(7)
# global cart_throughout_path = []
# global all_gif_environments = []
# global all_observed_environments = []
# global all_generated_beliefs = []
# global all_generated_trees = []
# global all_risky_scenarios = []
# #Sense humans near cart before moving
# #Generate Initial Lidar Data and Belief for humans near cart
# env_right_now.cart_lidar_data = get_lidar_data(env_right_now,lidar_range)
# env_right_now.cart_lidar_data = get_nearest_n_pedestrians_in_cone_pomdp_planning_2D_action_space(env_right_now.cart,
...
#             steering_angle = atan((env_right_now.cart.L*a[1])/env_right_now.cart.v)
#             current_belief, risks_in_simulation = simulate_cart_and_pedestrians_and_generate_gif_environments_when_cart_moving(env_right_now,
#                                                                 current_belief, all_gif_environments, all_risky_scenarios, global time_taken_by_cart,
#                                                                 global num_humans_to_care_about_while_pomdp_planning, global cone_half_angle, global lidar_range,
#                                                                 MersenneTwister( Int64( floor( 100*rand(user_defined_rng) ) ) ),steering_angle)
#             global number_risks += risks_in_simulation
#         else
#             #That means the cart is stationary and we now just have to simulate the pedestrians.
#             current_belief, risks_in_simulation = simulate_pedestrians_and_generate_gif_environments_when_cart_stationary(env_right_now,
#                                                                 current_belief,all_gif_environments, all_risky_scenarios, global time_taken_by_cart,
...
#     else
#         write_and_print( io, "Cart ran into Boundary Walls")
#         global cart_ran_into_boundary_wall_near_goal_flag = true
#         break
#     end
#     close(io)
#     global time_taken_by_cart += 1
#     if(global time_taken_by_cart>200)
#         break
#     end
# end
#
# io = open(global filename,"a")
# if(global cart_ran_into_boundary_wall_near_goal_flag == false)
#     write_and_print( io, "Goal Reached! :D" )
#     write_and_print( io, "Time Taken by cart to reach goal : " * string(global time_taken_by_cart) )
# else
#     write_and_print( io, "Goal not reached properly! :(" )
#     write_and_print( io, "Time Taken by cart to reach near goal : " * string(global time_taken_by_cart) )
# end
# write_and_print( io, "Number of risky scenarios encountered by the cart : " * string(global number_risks) )
# close(io)
#
#
#
